...
import { Mail, Phone, Menu, X, Download, ArrowRight, Globe, Layout, Server, Database, Terminal, Code, Linkedin, Github, Sparkles } from 'lucide-react';
...
const SkillCard = ({ category, index }) => (
  <motion.div
    ...
    className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group"
  >
...
const ProjectCard = ({ project, index }) => (
  <motion.div
    ...
    viewport={{ once: true }}
    transition={{ duration: 0.5, delay: index * 0.1 }}
    className="group relative rounded-2xl overflow-hidden bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full"
  >
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-500 selection:text-white overflow-x-hidden">
              ...
              <div className="px-6 py-4 space-y-2">
                {['about', 'skills', 'projects', 'contact'].map((item) => (
                  <a
                    key={item}
                    href={`#${item}`}
                    className="block px-4 py-3 text-base font-semibold text-slate-600 hover:bg-slate-50 rounded-lg hover:text-indigo-600"
      ...
      {/* Hero Section */}
      <section id="about" className="pt-40 pb-20 px-6 max-w-7xl mx-auto min-h-screen flex items-center">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-heading font-bold tracking-tight mb-6 leading-[1.1] text-slate-900">
            ...
            <p className="text-lg text-slate-600 mb-10 max-w-2xl leading-relaxed">
              ...
              <span className="font-semibold text-indigo-600">Java and  MERN stack</span>. I build scalable applications with Spring Boot, React, Node.js, Express, and MongoDB, with strong experience in REST APIs, authentication, CI/CD, Docker, and cloud platforms. I focus on clean architecture, performance, and creating user-centric solutions.
            </p>

            <div className="flex flex-wrap gap-4">
              <a href="#projects" className="px-8 py-4 bg-slate-900 text-white font-bold rounded-full hover:bg-indigo-600 transition-all flex items-center gap-2 hover:-translate-y-1 shadow-xl shadow-indigo-500/20">
          ...
          >
            ...
            <div className="relative aspect-square">
              ...
              <div className="absolute -bottom-8 left-20 w-32 h-32 bg-blue-200 rounded-full blur-3xl opacity-50 animate-blob animation-delay-4000"></div>
              ...
              <div className="relative z-10 bg-white/40 backdrop-blur-xl border border-white/50 rounded-3xl p-8 shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500">
                ...
                <div className="space-y-3 font-mono text-sm">
                  ...
                  <div className="pl-4 flex gap-2">
                    ...
                    <span className="text-green-600">"Jithin Jose"</span>,
                  </div>
                  <div className="pl-4 flex gap-2">
                  ...
                  <div className="pl-4 flex gap-2">
                    ...
                    <span className="text-slate-600">['React', 'Node', 'Java']</span>
                  </div>
                  <div className="text-slate-600">{'}'}</div>
                  <div className="pt-4 flex gap-2">
                    <span className="text-purple-600">await</span>
                    <span className="text-blue-600">developer</span>.
                    <span className="text-yellow-600">buildAwesomeThings</span>();
                  </div>
                </div>
              </div>
      ...
      {/* Skills Section */}
      <section id="skills" className="py-32 relative bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 mb-6">Technical <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-fuchsia-600">Arsenal</span></h2>
            <p className="text-slate-600 text-lg">A comprehensive toolkit for building robust and scalable applications.</p>
          </motion.div>
      ...
      <section id="projects" className="py-32 max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-slate-900 mb-4">Selected <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-pink-600">Works</span></h2>
          </motion.div>
          <motion.a
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            ...
            className="flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-fuchsia-600 transition-colors px-6 py-3 bg-white border border-slate-200 rounded-full hover:shadow-md"
          >
      ...
      <footer id="contact" className="py-32 relative bg-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-5xl md:text-7xl font-heading font-bold text-slate-900 mb-8 tracking-tight"
          >
          ...
          >
            <a href="mailto:jithinjose10341@gmail.com" className="w-full md:w-auto px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-indigo-600 transition-all hover:scale-105 flex items-center justify-center gap-3 shadow-xl shadow-indigo-500/20">
              <Mail size={20} /> jithinjose10341@gmail.com
            </a>
            <a href="tel:+917012400124" className="w-full md:w-auto px-8 py-4 bg-white text-slate-900 font-bold rounded-2xl border border-slate-200 hover:border-indigo-500 hover:text-indigo-600 transition-all hover:scale-105 flex items-center justify-center gap-3 shadow-sm">
